        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12 col-xl-6">
                    ...
                    <h4 class="mil-mb-60">Lorem ipsum dolor sit amet, <span class="mil-accent">consectetur adipiscing
                            elit</span>, sed do eiusmod tempor incididunt ut labor aliqua.</h4>

                </div>
                <div class="col-lg-12 col-xl-6">

                    <div class="mil-adaptive-right">
                        <a href="#." class="mil-button mil-border mil-mr-15 mil-mb-30"><span>Talk To an
                                Expert</span></a>
        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <h2 class="mil-mb-50">We Specialize in <br><span class="mil-accent">Transforming Your Idea</span> or
                        Business in The Current<br> Digital Era.</h2>

                    <p class="mil-mb-50">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
        ...
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-lg-6">
                    ...
                    <h3 class="mil-mb-60">Accelerate <span class="mil-accent">Innovation</span> with world class tech
                        teams We’ll match you to an entire <span class="mil-accent">Remote Technology</span></h3>
        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-lg-6 mil-mb-60">
                    ...
                    <p class="mil-mb-50">Many desktop publishing packages and web page editors now use Lorem Ipsum as
                        their default model text, and a search for 'lorem ipsum' will uncover many web sites still in
                        their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on
                        purpose. There are many variations of passages majority.</p>
            ...
            <div class="mil-line-icon-box">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6">
                        ...
                        <p class="mil-box-text mil-mb-30">Et iusto odio dignissim qui blandit praesent luptatum zzril
                            delenit. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie
            ...
            <div class="mil-line-icon-box">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6">
                        ...
                        <p class="mil-box-text mil-mb-30">Facilisis at vero eros et accumsan et iusto odio dignissim.
                            Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel
                            illum dolore eu feugiat nulla qui blandit praesent luptatum zzril delenit.</p>
            ...
            <div class="mil-line-icon-box">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6">
                        ...
                        <p class="mil-box-text mil-mb-30">Dolore eu feugiat nulla facilisis at. Quis autem vel eum
                            iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum vero eros et
                            accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit.</p>
            ...
            <div class="mil-line-icon-box">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6">
                        ...
                        <p class="mil-box-text mil-mb-30">Duis autem vel eum iriure dolor in hendrerit in vulputate
                            velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et
                            accumsan et iusto odio dignissim qui blandit praesent luptatum zzril.</p>
            ...
            <div class="mil-line-icon-box">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6">
                        ...
                        <p class="mil-box-text mil-mb-30">Blandit praesent luptatum zzril. Duis autem vel eum iriure
                            dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat
                            nulla facilisis at vero eros et accumsan et iusto odio dignissim qui delenit.</p>
                ...
                <div class="col-md-6 col-xl-4">
                    ...
                    <div class="mil-icon-box-2 mil-mb-60">
                        ...
                        <div class="mil-box-text">
                            ...
                            <p class="mil-box-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
